    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="card">
                    <div class="card-header" style="display: flex;justify-content: space-between">Add New Supplier
                        <a href="{{ route('suppliers.index') }}" class="btn btn-secondary">Back to Supplier List</a>
                    </div>

                    <div class="card-body">
                        <form id="create-supplier-form" method="POST" action="{{ route('suppliers.store') }}">
                            @csrf
